...
```bash
python3 13-tools/audit_course.py
```

The audit uses temporary copies of `12-data/chinook.db` and `12-data/northwind.db`.
...
```bash
python3 13-tools/audit_course.py --litecli
```
