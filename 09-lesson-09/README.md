...
and SQL Explorer. Lesson 08's date-as-text story pays off here,
...
**Before you start** — this lesson *writes*. Open SQL Explorer and select
`chinook.db`. Work in its in-memory copy; click **Load** again when you need a
clean session. The GitHub database stays untouched.
