...
EXPECTED_ERROR_BLOCKS = {
    ("lesson-01/lesson.md", 18),
    ("lesson-03/lesson.md", 19),
    ("lesson-07/lesson.md", 9),
    ("lesson-07/lesson.md", 18),
    ("lesson-09/lesson.md", 8),
    ("lesson-09/lesson.md", 9),
    ("lesson-09/lesson.md", 10),
    ("lesson-09/lesson.md", 13),
    ("lesson-09/lesson.md", 19),
    ("lesson-09/lesson.md", 20),
    ("lesson-09/lesson.md", 21),
    ("lesson-09/lesson.md", 25),
}
...
def audit_document(root: Path, document: Document):
    database = root / "data" / f"{document.database}.db"
...
def main():
    ...
    for error in final_exam_errors:
        print(f"FAIL final-test/exam.md: {error}")
